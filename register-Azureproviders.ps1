...
New-AzResourceGroup -Name rg-juiceshop-prod-lod -Location $location -Tag @{ LabInstance = $LabInstance; Environment = 'Prod' }
New-AzResourceGroup -Name rg-juiceshop-dev-lod -Location $location -Tag @{ LabInstance = $LabInstance; Environment = 'Dev' }
